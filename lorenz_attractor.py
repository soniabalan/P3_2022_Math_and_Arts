...
# Set initial values
xs[0], ys[0], zs[0] = (2.6, 0.1, 0.0) # 0.0 , 1.0, 1.05
...
# save_folder = 'images/lorenz-animate1'
# if not os.path.exists(save_folder):
#     os.makedirs(save_folder)


# # define the initial system state (aka x, y, z positions in space)
# initial_state = [0, 2, 2] # 0.1, 0, 0
...
#     y = xyz[:, 1]
#     z = xyz[:, 2]
#     ax.plot(x, y, z, color='c', alpha=0.7, linewidth=0.7)
#     ax.set_xlim((-30,30))
#     ax.set_ylim((-30,30))
#     ax.set_zlim((0,50))
#     ax.set_title('Lorenz attractor', fontproperties=title_font)
    
#     plt.savefig('{}/{:03d}.png'.format(save_folder, n), dpi=180, bbox_inches='tight', pad_inches=0.1)
#     plt.close()
...
# gif_filepath = 'images/animated-lorenz-attractor1.gif'
